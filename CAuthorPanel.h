...
#ifndef _CAuthorPanel_h_
#define _CAuthorPanel_h_

#include <wx/wx.h>
#include "gui.h"

class CAuthorPanel : public CAuthorPanelBase
{
    public:
        CAuthorPanel(wxWindow* parent, wxWindowID id = wxID_ANY, const wxPoint& pos = wxPoint(-1,15), const wxSize& size = wxSize(-1,-1), long style = wxTAB_TRAVERSAL);
        virtual ~CAuthorPanel();
};
